        ...
        <div className="min-h-screen bg-[#1e1e2e] flex items-center justify-center p-4 font-pixel text-[#94a3b8]">
            <div className="bg-[#1e1e2e] p-8 border-4 border-[#2d2d44] w-full max-w-md space-y-8 shadow-[8px_8px_0_0_rgba(0,0,0,0.5)]">
                <div>
                    ...
                    <p className="text-center text-[#6b7280] uppercase">[Initialize Account]</p>
                </div>
                ...
                <form className="space-y-6">
                    ...
                    <button formAction={signup} className="w-full bg-blue-600 hover:bg-blue-500 text-white text-xl uppercase font-bold py-3 px-4 border-b-4 border-blue-900 active:border-b-0 active:translate-y-1 transition-all">
                        [EXECUTE_SIGNUP]
                    </button>

                    <p className="text-center text-xl text-[#6b7280] uppercase">
                        Already Registered? <a href="/login" className="text-blue-400 hover:underline decoration-2 underline-offset-4">[LOGIN]</a>
                    </p>
                </form>
            </div>
        </div>
